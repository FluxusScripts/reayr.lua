...
Section:NewKeybind("Закрывания хаба на клавишу..", "Клавиша закрывания хаба", Enum.KeyCode.F6, function()
...
Section:NewButton("KAT","Кредиты для ?", function()
...
Section:NewButton("VHub Инфо-->","Ключ KillYourself", function()
...
Section:NewButton("Field Goal Simulator 100% точность","Кредиты для ?", function()
...
Frame.Position = UDim2.new(0, 0, 0.449392706, 0)
...
TextButton.Text = "Закрыть Руель"

TextButton.TextColor3 = Color3.fromRGB(254, 254, 254)
...
Frame2.BackgroundColor3 = Color3.fromRGB(71, 71, 71)

Frame2.BackgroundTransparency = 0.500

Frame2.Position = UDim2.new(0, 0, 0.449392706, 0)

Frame2.Size = UDim2.new(0, 68, 0, 25)
...
TextButton2.BackgroundColor3 = Color3.fromRGB(71, 71, 71)
...
TextButton2.Text = "Закрыть Руель"

TextButton2.TextColor3 = Color3.fromRGB(254, 254, 254)
